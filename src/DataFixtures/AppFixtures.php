...
final class AppFixtures extends Fixture
{
    ...
    {
        foreach ($this->getRecipeData() as [$title, $slug, $content, $createdAt, $duration]) {
            $recipe = new Recipe();
     ...
     * @throws \Exception
     *
     * @return array<int, array{0: string, 1: AbstractUnicodeString, 2: string, 3: \DateTime, 4: integer}>
     */
    private function getRecipeData(): array
    {
        $recipes = [];
